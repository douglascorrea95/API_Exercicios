...
public class ClienteController {
	...
	public ResponseEntity<ExibicaoClienteDTO> buscarPorId(@PathVariable Integer idCliente) throws ClienteException {
	...
	@GetMapping("/lista")
	public ResponseEntity<List<ExibicaoClienteDTO>> listaTodos() {
